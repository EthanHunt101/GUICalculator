...
# Might try and implement a stack later for the previous calculation part

# All functions I create will be added up here
def button_clicked(button):
    curr_num = str(calc_label.cget('text')) + str(button)

    calc_label.config(text = int(curr_num))
